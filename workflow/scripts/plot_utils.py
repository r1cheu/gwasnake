...
def manhattan_plot(
    ...
    data : pandas.DataFrame
        GWAS results with chromosome, position, and p-value columns
    chrom_col : str
    ...
    sort : bool
        Whether to sort data by chromosome and position
    log : bool
        Whether to transform p-values to -log10(p)
    colors : list
        Colors for alternating chromosomes
    figsize : tuple
        Figure size
    y_break : tuple, optional
        Y-axis break range (lower, upper)
